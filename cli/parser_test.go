...
func TestParseGridSize(t *testing.T) {
	...
	argument = "7x5 (0, 0) (1, 3) (4, 4) (4, 6) (4, 2) (0, 1) (3, 2) (2, 3) (4, 1)"
	b, err = parseGridSize(argument)
	assert.Nil(t, err)

	argument = "this is not parsable"
	b, err = parseGridSize(argument)
	assert.NotNil(t, err)
...
func TestParseBotParam(t *testing.T) {
	argument := "5x5 (0,0) (1,3) (4,4) (4,2) (4,2) (0,1) (3,2) (2,3) (4,1)"
	...
	p, err := ParseBotParam(argument)
	assert.Equal(t, expectedPath, p)
	assert.Nil(t, err)

	argument = "not parsable"
	p, err = ParseBotParam(argument)
	assert.NotNil(t, err)
}